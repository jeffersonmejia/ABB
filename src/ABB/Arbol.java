...
public class Arbol {
	...
	public void mostrarIzq() {
		mostraIzq(this.raiz.getIzquierdo());
	}

	// metedo con recursividad
	public void mostraIzq(Nodo nodo) {
		if (!esVacio(nodo)) {
			if (nodo.getClave() < raiz.getClave()) {
				mostraIzq(nodo.getDerecho());
			}
			mostraIzq(nodo.getIzquierdo());
			System.out.print("Clave: " + nodo.getClave() + " | Objeto: " + nodo.getObjeto() + " | ");
		}
	}
	 ...
	 */
	public void mostrarDerec() {
		mostrarDerec(this.raiz.getDerecho());
	}

	//metodo recursividad
	public void mostrarDerec(Nodo nodo) {
		if (!esVacio(nodo)) {
			if (nodo.getClave() > raiz.getClave()) {
				mostrarDerec(nodo.getDerecho());
			}
			mostraIzq(nodo.getIzquierdo());
			System.out.print("Clave: " + nodo.getClave() + " | Objeto: " + nodo.getObjeto() + " | ");
		}
